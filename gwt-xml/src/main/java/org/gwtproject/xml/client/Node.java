...
/**
 * This is the base interface for DOM nodes, as obtained from using <code>XMLParser</code> methods.
 * Methods for iterating over and accessing values from nodes are supplied here.
 */
public interface Node {
  ...
  /**
   * This method may collapse adjacent text nodes into one text node, depending on the
   * implementation. Safari 4.0 and Chrome will also merge CDATA nodes into text nodes, even though
   * they support CDATA nodes as distinct nodes.
   */
  void normalize();
