...
/**
 * This interface describes <code>CharacterData</code> XML nodes. These can be either <code>Text
 * </code>, <code>CDATASection</code> or <code>Comment</code> nodes.
 */
public interface CharacterData extends Node {
  /**
   * This method appends <code>data</code> to the data in this <code>CharacterData</code>.
   *
  ...
  /**
   * This method deletes data, starting at <code>offset</code>, and deleting <code>count</code>
   * characters.
   *
  ...
  /**
   * This method replaces the substring of data indicated by <code>offset</code> and <code>count
   * </code> with <code>replacementData</code>.
   *
