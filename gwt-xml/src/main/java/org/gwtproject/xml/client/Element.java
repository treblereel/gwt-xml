...
/**
 * This interface represents XML DOM elements, which are the basic building block of XML. An example
 * follows:
 *
 * <pre>
...
public interface Element extends Node {
  ...
  /**
   * This method retrieves the attribute node which has a name of <code>name</code>. This <code>Attr
   * </code> will have the same value as would be gotten with <code>getAttribute</code>.
   *
   * @param name the name of the <code>Attr</code> to get
   * @return the attribute node of this <code>Element</code>which has a name of <code>name</code>
   */
  Attr getAttributeNode(String name);

  /**
   * This method retrieves the elements by tag name which has a name of <code>name</code>.
   *
   * @param name the name of the <code>Element</code> to get
   * @return the elements by tag name of this <code>Element</code> which has a name of <code>name
   *     </code>
   */
  ...
  /**
   * This method determines whether this <code>Element</code> has an attribute with the supplied
   * name.
   *
   * @param name the name of the attribute
   * @return <code>true</code> if this <code>Element</code> has an attribute that name.
   */
  ...
  /**
   * This method sets the attribute specified by <code>name</code> to <code>value</code>.
   *
