...
class ProcessingInstructionImpl extends NodeImpl implements ProcessingInstruction {
  ...
  private final elemental2.dom.ProcessingInstruction instructions;

  protected ProcessingInstructionImpl(elemental2.dom.ProcessingInstruction o) {
    super(o);
    this.instructions = o;
  }
  ...
  /** This function delegates to the native method <code>getTarget</code> in XMLParserImpl. */
  @Override
  ...
  public void setData(String data) {
    try {
      ...
      throw new DOMNodeException(DOMException.INVALID_CHARACTER_ERR, e, instructions);
    }
  }
